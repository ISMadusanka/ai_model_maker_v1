...
import { useDashboard } from "../../../context/DashboardProvider"; // Correct import path
...
export default function ProjectListPage() {
  ...
  // Function to handle click and set the project ID in the context
      ...
      <Row>
        ...
        {projects.map((project) => (
          <Col md={4} className="mb-4" key={project._id}>
            <Link to={`/projects`} onClick={() => handleClick(project._id)}>
              <ProjectItemCard
